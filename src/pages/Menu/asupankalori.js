...
export default function AsupanKaloriMakanan({navigation, route}) {
    const { id } = route.params; // Mendapatkan ID dari navigasi

    const RekomendasiMakanan = [
        {
          id: 1,
          title: 'Asupan Kalori Makanan 1',
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`,
        ...
        },
        {
          ...
          description: 'Asupan Kalori Makanan 2',
          image: require('../../assets/makanan_sehat2.png'),
        },
        {
          id: 3,
          title: 'Asupan Kalori Makanan 3',
          description: 'Asupan Kalori Makanan 3',
          image: require('../../assets/makanan_sehat3.png'),
        },
        {
          id: 4,
          title: 'Asupan Kalori Makanan 4',
          description: 'Asupan Kalori Makanan 4',
  ...
  return (
    ...
    <View>
        <MyHeader title="Asupan Kalori Makanan"/>
    </View>
     <ScrollView>
        {selectedItem ? (
            <>
